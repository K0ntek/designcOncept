...
const SectionTwo = () => {
  return (
    <div className=' grid lg:grid-cols-2 gap-10 my-10'>
        ...
        <div className='h-fit space-y-2 sm:space-y-5  max-w-[500px] lg:w-full mx-auto'>
            <div className='w-full aspect-[21/9] overflow-hidden bg-zinc-950 rounded-3xl sm:rounded-[40px]'>
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-5">
                <div className=' w-full aspect-square bg-zinc-950 overflow-hidden rounded-3xl sm:rounded-[40px]'>
